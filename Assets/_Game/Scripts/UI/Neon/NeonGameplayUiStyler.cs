...

{
...

    {
...

        {
            ...
            StyleFail(manager.GetComponentInChildren<FailPanel>(true), manager);

            StyleRetry(manager.GetComponentInChildren<RetryPanel>(true), manager);

        }



        public static void StyleWin(WinPanel win, GameUIManager ui)

        {
            ...
            CreateDialogButton(panel, "NextButtonNeon", "NEXT LEVEL", new Vector2(0f, -200f), new Vector2(620f, 96f),
                ...
                NeonTheme.UiCyanBorder, Color.white, win.PressNext);

        }



        public static void StyleFail(FailPanel fail, GameUIManager ui)

        {

            if (fail == null || ui == null)
            ...
            CreateDialogButton(panel, "RestartButtonNeon", "RETRY", new Vector2(0f, -40f), new Vector2(620f, 96f),
                ...
                NeonTheme.UiFail, Color.white, ui.OnRestartConfirmed);

            CreateDialogButton(panel, "HomeButton", "MAIN MENU", new Vector2(0f, -160f), new Vector2(620f, 96f),

                NeonTheme.UiMagentaBorder, NeonTheme.UiText, ui.OnReturnToMainMenu);

        }



        public static void StyleRetry(RetryPanel retry, GameUIManager ui)

        {

            if (retry == null || ui == null)
            ...
            CreateDialogButton(panel, "YesButtonNeon", "YES", new Vector2(0f, -70f), new Vector2(620f, 96f),
                ...
                NeonTheme.UiMagentaBorder, Color.white, ui.OnRestartConfirmed);

            CreateDialogButton(panel, "NoButtonNeon", "NO", new Vector2(0f, -190f), new Vector2(620f, 96f),

                NeonTheme.UiCyanBorder, NeonTheme.UiHudText, () => retry.Hide(false));
